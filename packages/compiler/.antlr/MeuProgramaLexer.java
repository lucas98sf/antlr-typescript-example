...
public class MeuProgramaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__25", "T__26", "T__27", "T__28", "ID", "NUMBER", "STRING", "WS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'programa'", "'declare'", "'inicio'", "'fim'", "'fimprog'", "','", 
			"':'", "';'", "'number'", "'text'", "'escreva'", "'('", "')'", "'leia'", 
	...
	public MeuProgramaLexer(CharStream input) {
		super(input);
